# Modified from 'WinMsvc.cmake' in the LLVM project.
...
set(WINSDK_INCLUDE "${XWIN_SPLAT}/sdk/include")
#set(WINSDK_LIB     "${LLVM_WINSYSROOT}/Windows Kits/10/Lib/${WINSDK_VER}")
set(WINSDK_LIB     "${XWIN_SPLAT}/sdk/lib")
...
set(CMAKE_C_COMPILER "/bin/clang-cl" CACHE FILEPATH "")
set(CMAKE_CXX_COMPILER "/bin/clang-cl" CACHE FILEPATH "")
set(CMAKE_LINKER "/bin/lld-link" CACHE FILEPATH "")
set(CMAKE_AR "/bin/llvm-lib" CACHE FILEPATH "")
...
set(COMPILE_FLAGS
    ...
    -vctoolsdir ${XWIN_SPLAT}/crt
    -winsdkdir ${XWIN_SPLAT}/sdk)
